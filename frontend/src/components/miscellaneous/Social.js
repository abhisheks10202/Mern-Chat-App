...
const Social = () => {
  return (
    <StyledWrapper >
      <div className="main" >
        <div className="card"  >
        <a href="https://instagram.com/abhisheks10202" target="_blank" rel="noopener noreferrer">
          <svg
            fillRule="nonzero"
            height="30px"
            width="30px"
        ...
        <div className="card">
        <a href="https://github.com/abhisheks10202" target="_blank" rel="noopener noreferrer">
          <svg
            height="30px"
            width="30px"
            viewBox="0 0 30 30"
